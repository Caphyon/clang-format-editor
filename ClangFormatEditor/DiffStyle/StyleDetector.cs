...
namespace ClangFormatEditor.DiffStyle
{
  public class StyleDetector
  {
    #region Members

    private FormatStyle detectedStyle;
    private List<string> filesContent;
    private readonly Dictionary<FormatStyle, int> detectedPredefinedStyles;
    ...
    {
      detectedPredefinedStyles = new Dictionary<FormatStyle, int>();
    ...
    public async Task<(FormatStyle matchedStyle, List<IFormatOption> matchedOptions)> DetectStyleOptionsAsync(List<string> filesContent, CancellationToken cancelToken)
    {
    ...
    private async Task DetectFileStyleAsync(string content, CancellationToken cancelToken)
    {
      await Task.Run(() =>
      {
        foreach (FormatStyle style in Enum.GetValues(typeof(FormatStyle)))
        {
          if (style == FormatStyle.Custom) continue;
    ...
    private async Task DetectFileOptionsAsync(string content, FormatStyle style, CancellationToken cancelToken)
    {
      await Task.Run(() =>
      {
    ...
    private FormatStyle GetStyleByLevenshtein(Dictionary<FormatStyle, int> stylesLevenshtein)
    {
    ...
    private void SetOptionMultipleToggle(FormatOptionMultipleToggleModel multipleToggleModel, string input, List<IFormatOption> formatOptions, FormatStyle formatStyle)
    {
    ...
    /// <param name="input"></param>
    private void SetOptionToggle(FormatOptionToggleModel modelToggle, string input, FormatStyle formatStyle, List<IFormatOption> formatOptions)
    {
    ...
    /// <param name="input"></param>
    private void SetOptionInput(FormatOptionInputModel inputModel, string input, FormatStyle formatStyle, List<IFormatOption> formatOptions)
    {
    ...
    private int GetLevenshteinAfterFormat(string input, FormatStyle formatStyle, List<IFormatOption> formatOptions)
    {
    ...
    private void SetFormatOption(IFormatOption formatOption, string input, FormatStyle formatStyle, List<IFormatOption> formatOptions)
    {
      switch (formatOption)
      {
